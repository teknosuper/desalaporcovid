    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jumlah Posko <?= \yii::$app->user->identity->namaKelurahan;?></span>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jumlah Laporan <?= \yii::$app->user->identity->namaKelurahan;?></span>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jumlah Pantauan <?= \yii::$app->user->identity->namaKelurahan;?></span>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jumlah Pengguna <?= \yii::$app->user->identity->namaKelurahan;?></span>

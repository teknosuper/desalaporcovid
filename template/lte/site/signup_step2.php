...
<div class="login-box panel panel-default">
    ...
    <div class="login-box-body">
        ...
        <div class="row">
            ...
            <!-- /.col -->
            <div class="col-md-12">
                <?= Html::submitButton('Konfirmasi pendaftaran', ['class' => 'btn btn-success btn-block btn-flat', 'name' => 'login-button','data-method'=>'post','data-confirm'=>'Apakah data yang anda masukkan sudah benar ? ']) ?>
            </div>
            <!-- /.col -->
        </div>
